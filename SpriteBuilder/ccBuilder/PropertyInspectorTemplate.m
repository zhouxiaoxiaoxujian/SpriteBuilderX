...
- (void) applyToNode:(CCNode*) node
{
    for (id propInfo in self.properties)
    {
        ...
        [CCBReaderInternal setProp:name ofType:type toValue:serializedValue forNode:node parentSize:CGSizeMake(0, 0) withParentGraph:nil fileVersion:kCCBFileFormatVersion];
    }
}
